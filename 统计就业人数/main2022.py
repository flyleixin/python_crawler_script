...
def excelData():
    wb = openpyxl.load_workbook('./2022.xlsx')
    sheet = wb.active
    ...
    yanjiusheng = 0
    for i in cells:
        if i.value == "801" or i.value == "802" or i.value == '71' or i.value == '85':
            yanjiusheng += 1
        ...
        for i in range(minrow, maxrow + 1):
            ...
            if col_zy == s:
                ...
                if sheet.cell(i, 40).value == "701":
                    zy_shiye += 1
                if sheet.cell(i, 40).value == "801" or sheet.cell(i, 40).value == "802" or sheet.cell(i,
                                                                                                      40).value == '71' or sheet.cell(
                    i, 40).value == '85':
                    zy_yanjiusheng += 1
